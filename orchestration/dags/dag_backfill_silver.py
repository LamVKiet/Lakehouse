...
customer_activity_monthly_backfill = create_spark_task(dag, "batch_silver_customer_activity_monthly_backfill.py")
end   = DummyOperator(task_id="END", dag=dag)

# All three backfills are independent (no inter-dependency after retention moved to Gold)
start >> nou_backfill >> end
start >> transactions_backfill >> end
start >> customer_activity_monthly_backfill >> end
